...
const Footer = () => {
  return (
    <footer>
      <img src={logo3} id="row-img" alt="footer background" />
      <div id="story-row">
        ...
        <div className="story-row-inner">
          ...
          <div>
            ...
            <p className="footer-stories">
              There’s no Qwerty warehouse – just millions of people selling the
      ...
      <img src={logo2} id="row-img" alt="footer background" />
      <img src={logo} id="row-img" alt="footer background" />
      <div id="row2">
        <BsGlobe size={23} />
        ...
        <div id="row3-inner">
          ...
          <div>
            ...
            <a
              ...
              href="https://www.linkedin.com/in/steve-correa/"
              target="_blank"
              rel="noreferrer"
            >
              Steve Correa
            ...
            <a
              className="footer-link"
              href="https://www.linkedin.com/in/grant-ellis-russell"
              target="_blank"
              rel="noreferrer"
            >
              Grant Russell
            ...
            <a
              className="footer-link"
              href="https://www.linkedin.com/in/eddie-verdusco/"
              target="_blank"
              rel="noreferrer"
            >
              Eddie Verdusco
          ...
          <div>
            ...
            <a
              className="footer-link"
              href="https://github.com/scorrea310"
              target="_blank"
              rel="noreferrer"
            >
              Steve Correa
            ...
            <a
              className="footer-link"
              href="https://github.com/grantongrant"
              target="_blank"
              rel="noreferrer"
            >
              Grant Russell
            ...
            <a
              className="footer-link"
              href="https://github.com/verduscos"
              target="_blank"
              rel="noreferrer"
            >
              Eddie Verdusco
